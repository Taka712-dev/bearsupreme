...
function wn(e) {
    ...
    return {
        c() {
			...
			animation-duration: ${e[1]===3?"0.5s":"0s"};`), n(Ye, "href", "https://four.meme/token/0xComingSoon"), n(Ye, "target", "_blank"), ce(Me.src, bo = "/telegram.webp") || n(Me, "src", bo), n(Me, "alt", "Telegram"), n(Me, "class", "social-image-3"), n(be, "class", wt = "six-social-top-3 " + (e[1] === 3 ? "zoom-in" : "") + " svelte-cfhrno"), n(be, "style", _t = `opacity: ${e[1]===3?"0":"1"};
			transform: ${e[1]===3?"scale(0.9)":"scale(1)"};
